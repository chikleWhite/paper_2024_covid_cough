...
md_neg_table = table( ...
    'Size', [num_subj num_col_table], ...
    'VariableTypes', {'string', 'double', 'string' 'cell' 'cell'}, ...
    'VariableNames',{'subj_id' 'age' 'gender' 'current_symptoms' 'background_diseases'} ...
...
% 5. backgroundDiseases - exist
% 1. age range - in range: [10 90]
...
for i = 1 : num_subj % loop over all subjects in metadata
    ...
    if      ~isfield(md_subj.formData, 'covid19') || ...
            ...
            isempty(md_subj.formData.backgroundDiseases) || ...
            isempty(md_subj.formData.age) || ...
            ~isnumeric(md_subj.formData.age) || ...
            md_subj.formData.age < 10 || ...
            md_subj.formData.age > 90
        continue;
    else
        covid_status        = string(md_subj.formData.covid19.diagnosedCovid19);
        age                 = md_subj.formData.age;
...
%         md_neg_table.current_symptoms(neg_count)  = current_symptoms;
        md_neg_table.background_diseases(neg_count)  = {strjoin(background_diseases, ', ')};
    end
...
% % save in file
% save ../../ds/ds_load_voca md md_pos md_pos_table md_neg md_neg_table
...
% loop over all negative subjects
for i = 1 : num_subj_neg
...
metadata_voca_negative = table( ...
    ...
    md_neg_table.age, ...
    md_neg_table.gender, ...
    md_neg_table.current_symptoms, ...
    md_neg_table.background_diseases, ...
    'VariableNames',{'audio_file_location','ds','class','age','gender','current_symptoms','background_diseases'});
