function net = extractNetFromCheckpoint(net_info, checkpointPath)
...
net_name = nets_list(datenums_indices(min_ValidationLoss_indx)).name;

% load best net
net = load(checkpointPath + '/' + net_name);
net = net.net;
