function extract_scores_classification_CNN(lbls_pred_cell, lbls_true_cell, net_cnn_name, dataset_name, set_threshold, roc_threshold)
...
writetable(scores_table, ...
    ['covid classification results ', char(net_cnn_name), ' ', char(dataset_name), '/scores classification CNN.csv'], ...
    'WriteRowNames', true);
disp('scores:');
disp(scores_table);
